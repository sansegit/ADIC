%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% EXAMPLE 3: CORRELATION OF NEUTRON RADIOGRAPHIES OF WOOD FIBER COMPOSITES %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Ex3_NeutronRadiography_WoodFiberComposites
...
% Load test images
input_ref  = load('../data/Ex3_ImageRef.mat'); input_ref = double(input_ref.data);
input_test = load('.../data/Ex3_ImageTest.mat'); input_test = double(input_test.data);

% Define ANRC deformation computation parameters
parameters_deformation = struct('WR', [10 10], ...
                    'WS',     [3 3], ...
                    'WL',     [5 5], ...
                    'subset', [31 61],... 
                    'ov',     [1 1], ... 
...
parameters_strain = struct('latresx_ux', 31,  ...         
                           'latresy_ux', 61, ...
                           'latresx_uy', 31, ...
                           'latresy_uy', 61, ...
                           'fixnans', 0);
...
save('../results/Ex3_results.mat', 'output_def', 'output_str', 'epsXX_mean', 'epsYY_mean', 'epsXY_mean');

end

% Load results
load('../results/Ex3_results.mat');
